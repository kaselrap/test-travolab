...
@section('tab')
    <div id="v-pills-organization-types" aria-labelledby="v-pills-organization-types-tab">
        <div class="row mb-3">
            <div class="col-md-12">
                <a href="{{route('organization.types.create')}}" class="btn btn-outline-primary">
        ...
        <form class="form-sort-find">
            ...
            <table class="table table-striped">
                ...
                <tr>
                    ...
                    <th class="border-left-0">
                        <div class="form-group">
                            ...
                            <a href="{{route('organization.types')}}" class="btn btn-danger reset_form">
                ...
                <tbody>
                @include('organization-type.items', ['organizationTypes' => $organizationTypes])
                </tbody>
            </table>
        </form>
    </div>
