 ...
 * Generated for Laravel 5.8.17 on 2019-06-01 21:09:36.
 *
...
namespace App\Facades { 
    ...
    class OrderFacade {
         ...
         * @static 
         */ 
        public static function compare($name, $value)
        {
                        /** @var \App\Services\OrderService $instance */
                        return $instance->compare($name, $value);
        }
    ...
    class ExcelFacade {
         ...
         * @static 
         */ 
        public static function getDataFromDatabase($class, $fields = array(), $joins = array(), $wheres = array())
        {
                        /** @var \App\Services\ExcelService $instance */
                        return $instance->getDataFromDatabase($class, $fields, $joins, $wheres);
        }
         ...
         * @return \App\Services\Spreadsheet 
         * @throws \PhpOffice\PhpSpreadsheet\Exception
         * @static 
         */ 
        public static function createDocument($array, $name = '', $translates = array(), $leaderName = '')
        {
                        /** @var \App\Services\ExcelService $instance */
                        return $instance->createDocument($array, $name, $translates, $leaderName);
        }
         ...
         * @static 
         */ 
        public static function downloadDocument($spreadsheet, $type = '')
        {
                        /** @var \App\Services\ExcelService $instance */
                        return $instance->downloadDocument($spreadsheet, $type);
        }
...
namespace  { 
    ...
    class Order extends \App\Facades\OrderFacade {}

    class Excel extends \App\Facades\ExcelFacade {}
